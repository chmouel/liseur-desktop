...
| ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| **M0 — Foundation**                   | Electron + Vite + SolidJS + strict TS scaffold, secure process boundaries, worker skeleton, typed preload API, instant app shell, docs, CI                                                                                                                       | 🚧 in progress |
| **M1 — Responsive library prototype** | Library screen with 5,000 deterministic fake books, virtualized adaptive cover grid, Continue Reading, filters, sorting, instant search, keyboard navigation, light/dark themes, perf instrumentation, tests                                                     | 🚧 in progress |
